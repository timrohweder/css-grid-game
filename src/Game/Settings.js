        ...
        if ((e.key && e.key === 'Enter') || e.type === 'blur') {
            ...
            if (!isNaN(numTries) && numTries >= 1 && numTries <= 100) {
                ...
                this.setState({
                    message: (
                        <ErrorMessage>
                            Please enter a number ranging 1 through 100.
                        </ErrorMessage>
                    )
                });
            }
            ...
            <Layout>
                <SettingsWrapper>
                    ...
                    <label>
                        Game Size
                        <select
                            value={this.context.numCols}
                            onChange={this.handleSetNumCols}
                        >
                    ...
                    <label>
                        Number of Tries
                        <input
                            placeholder={this.context.triesToStart}
                            type="number"
                            min="1"
                            max="100"
                            onBlur={this.handleSetNumTries}
                            onKeyPress={this.handleSetNumTries}
                        />
                    </label>
